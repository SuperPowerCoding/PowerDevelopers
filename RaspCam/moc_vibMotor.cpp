...
QT_MOC_LITERAL(1, 9, 17), // "vibrationFinished"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "VibMotor\0vibrationFinished\0"
};
...
void VibMotor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VibMotor *_t = static_cast<VibMotor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->vibrationFinished(); break;
        default: ;
        }
        ...
        {
            typedef void (VibMotor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VibMotor::vibrationFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VibMotor::vibrationFinished()
{
